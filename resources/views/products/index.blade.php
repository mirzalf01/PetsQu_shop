        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <tr>
                        <td>{{ $counter++ }}</td>
                        <td><img style="width: 75px; height: 75px; object-fit: cover" src="{{ asset('gambar_produk/'.$product->img) }}" alt=""></td>
                        <td>{{ $product->name }}</td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" novalidate="" method="post" action="{{ route('products.update', 0) }}" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Deskripsi *</label>
                <textarea id="productDetail" class="form-control" name="detail" value="{{old('detail')}}"></textarea>
                <div class="invalid-feedback">
                  Deskripsi produk tidak boleh kosong!
                </div>
              </div>
              <div class="form-group">
                <label>Stok *</label>
                <input type="number" id="productStock" name="stock" class="form-control" required="" value="{{old('stock')}}">
                <div class="invalid-feedback">
                    Stok tidak boleh kosong!
                </div>
              </div>
